    ...
    // Not awaiting reply////////////////////////////////////////////////////////
      ...
      if (senderId && context) {
        ...
        if (first_intent == "start_workout") {
          ...
          if (!data.entities.exercise) return cb(null, context, "Sorry, that exercise is not in my system yet.")
          ...
          if (!context.inWorkout) {
            ...
            context.awaitingMessagePos = "Start workout";
            context.awaitingMessageNeg = "continue";
						return cb(null, context, "Nice, but you haven't told me that you're starting a workout. Are you starting one?");
        ...
        // USER WANTS TO STOP CURRENT LEVEL
          ...
          // NOT IN EXERCISE
            ...
            if (context.inWorkout) {
							...
							if (!Object.keys(context.exercises).length) return cb(null, context, "Congratulations, you completed a grand total of zero exercises! Keep it up champ!");
          ...
          if (context.inExercise)
            ...
            context.awaitingMessagePos = "start workout";
            context.awaitingMessageNeg = "continue";
						return cb(null, context, "Are you starting a workout?");
					} else if (context.inExercise) {
      ...
      // New user
        ...
        context = {
          ...
          exercises: {}
				...
				cb(null, context, "Hi, I'm Jim the Gym Bot. I can help you log and analyze your workouts. Just say hey whenever you're starting a workout")
      }
    }
}
